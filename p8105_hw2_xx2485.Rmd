...
```
The `combined_trash_wheel_df` dataframe combines the data from three different trash wheels of Healthy Harbor company from the year 2014 to 2023, if data is available. The data includes the number of dumpster, date, weight, volumes, types of trash collected, and homes powered. 


**Mr. Trash Wheel**:

*  The dataset contains 584 observations and 15 categories for data. The data was collacted from 2014 to 2023.
*  The weight of trash collected ranges from 0.78 tons to 5.62 tons, with an average of 3.21 tons per dumpster. Cumulatively, Mr. Trash Wheel has collected approximately 1875.7 tons of trash.
*  The volume ranges from 7 to 20 cubic yards, averaging 15.3 cubic yards per dumpster, totaling approximately 8935.2 cubic yards of trash.

*  Plastic Bottles: An average of 1979 bottles per dumpster, with a cumulative total of 1156696 plastic bottles.
*  Polystyrene: An average of 1558 units per dumpster, totaling 910672 units collected.
*  Cigarette Butts: Each dumpster collects an average of 19833 butts, summing up to 11587312 cigarette butts.
*  Glass Bottles: An average of 21.62 bottles per dumpster, resulting in a total of 12623 glass bottles.
*  Plastic Bags: An average of 916.8 bags per dumpster, amounting to 535347 plastic bags.
*  Wrappers: An average of 1416 wrappers per dumpster, with a cumulative total of 827744 wrappers.
*  Each dumpster powers an average of 47.28 homes, with a cumulative total of 27606.72 homes powered by the collected trash.

**Professor Trash Wheel**:

* The dataset contains 106 observations and 14 categories for data. The data was collected from 2017 to 2023.
* The weight of trash collected ranges from 0.61 tons to 3.72 tons, with an average of 2.04 tons per dumpster. Cumulatively, Professor Trash Wheel has collected approximately 216.26 tons of trash.
* The volume ranges from 6 to 18 cubic yards, averaging 14.58 cubic yards per dumpster, totaling approximately 1546 cubic yards of trash.

*  Plastic Bottles: An average of 5244 bottles per dumpster, with a cumulative total of 550646 plastic bottles.
*  Polystyrene: An average of 4194 units per dumpster, totaling 440405 units collected.
*  Cigarette Butts: Each dumpster collects an average of 11531 butts, summing up to 1210778 cigarette butts.
*  Glass Bottles: An average of 16.81 bottles per dumpster, resulting in a total of 1765 glass bottles.
*  Plastic Bags: An average of 2433 bags per dumpster, amounting to 255514 plastic bags.
*  Wrappers: An average of 7695 wrappers per dumpster, with a cumulative total of 807982 wrappers.
*  Each dumpster powers an average of 34 homes, with a cumulative total of 3604.33 homes powered by the collected trash.

**Gwynnda the Good Wheel of the West**:

*  The dataset contains 155 observations and 11 categories for data. The data was collected from 2021 to 2023.
*  The weight of trash collected ranges from 0.77 tons to 4.18 tons, with an average of 2.91 tons per dumpster. Cumulatively, Gwynnda has collected approximately 451.67 tons of trash.
*  The volume ranges from 5 to 15 cubic yards, averaging 14.9 cubic yards per dumpster, totaling approximately 2309.5 cubic yards of trash.

*  Plastic Bottles: An average of 1495 bottles per dumpster, with a cumulative total of 231725 plastic bottles.
*  Polystyrene: An average of 170.7 units per dumpster, totaling 26458.5 units collected.
*  Cigarette Butts: Each dumpster collects an average of 2368 butts, summing up to 367040 cigarette butts.
*  Plastic Bags: An average of 788.8 bags per dumpster, amounting to 122264 plastic bags.
*  Wrappers: An average of 1554 wrappers per dumpster, with a cumulative total of 214470 wrappers.
*  Each dumpster powers an average of 48.52 homes, with a cumulative total of 7510.6 homes powered by the collected trash.
...
For Season 1, the average viewership was 2.77; for Season 5, the average viewership was 10.0393.